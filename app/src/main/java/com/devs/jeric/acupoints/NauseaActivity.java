...
public class NauseaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final VideoView videoView = findViewById(R.id.videoViewnausea);
        ...
        final Button button = (Button)findViewById(R.id.playnausea);
        final Button pausebtn = (Button)findViewById(R.id.pausebtnnausea);
