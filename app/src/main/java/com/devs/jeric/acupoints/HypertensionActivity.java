...
public class HypertensionActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final VideoView videoView = findViewById(R.id.videoViewhypertension);
        ...
        final Button button = (Button)findViewById(R.id.playhypertension);
        final Button pausebtn = (Button)findViewById(R.id.pausebtnhypertension);
